...
//Canvas
function createMatrix(cols: number, rows: number): number[][] {
  const matrix = [];
...
//Checking Collide
function collide(arena: number[][], player: IPlayer): boolean {
...
//Merge with Arena
function merge(arena: number[][], player: IPlayer) {
